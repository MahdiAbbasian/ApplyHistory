...
import dev.abbasian.applyhistory.business.usecase.BaseUseCase
...
class CompanyWebSiteValidatorUseCase: BaseUseCase<String, DataResult> {
    override fun perform(input: String): DataResult {
